...
import ComputerImage from "../Images/MO/settings.png";
import laptopImage from "../Images/MO/laptop.png";
import newspaperImage from "../Images/B/newspaper.png";
import phoneImage from "../Images/MO/cell-phone.png";

const paperItems = [
	{ name: "Phone", img: phoneImage },
	{ name: "Laptop", img: laptopImage },
	{ name: "Computer", img: ComputerImage },
	...
	return (
		<section className="bg-white py-10 px-4 ">
			<div className="max-w-5xl mx-auto">
				{/* Heading */}
				<h1 className="text-white bg-black px-10 py-5 rounded-2xl text-4xl font-bold inline-block mt-6 mb-6">Electronics</h1>
